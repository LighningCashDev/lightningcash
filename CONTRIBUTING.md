Contributing to Lightningcash Core
============================
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to lightningcash-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the lightningcash unit tests or QA tests
...
Patches that change Lightningcash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Lightningcash consensus, it must have been
