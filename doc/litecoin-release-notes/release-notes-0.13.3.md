Lightningcash Core version 0.13.3 is now available from:

  <https://download.lightningcash.org/lightningcash-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/MerlinMagic2018/lightningcash/blob/0.13/src/chainparams.cpp#L214).
