...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lightningcash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lightningcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lightningcash transaction") + "\n" +
              "  lightningcash-tx [options] -create [commands]   " + _("Create hex-encoded lightningcash transaction") + "\n" +
              "\n";
