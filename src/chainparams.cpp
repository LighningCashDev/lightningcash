...
public:
    CMainParams() {
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xff, 0x88, 0xB2, 0x1E}; // xpub
        base58Prefixes[EXT_SECRET_KEY] = {0xff, 0x88, 0xAD, 0xE4}; // xprv
        ...
        chainTxData = ChainTxData{
            ...
            1537556574, // * UNIX timestamp of last known number of transactions
