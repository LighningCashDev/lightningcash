...
"""Verify that starting lightningcash with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lightningcash with -h for help text")
        ...
        self.log.info("Start lightningcash with -version for version information")
